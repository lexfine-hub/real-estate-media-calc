        ...
        <div className="max-w-md w-full">
          <div className="bg-gradient-to-br from-slate-50 to-white rounded-2xl border border-yellow-300 p-8 shadow-lg">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 bg-white border border-slate-300 hover:bg-slate-50 text-slate-900 font-semibold py-3 px-4 rounded-lg transition"
            >
